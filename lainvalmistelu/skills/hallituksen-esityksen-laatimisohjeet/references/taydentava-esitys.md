...
PERUSTELUT
  1 Asian tausta ja valmistelu
    1.1 Tausta
      - Aiemman esityksen / lain tausta
      - Täydennyksen tarve
    1.2 Valmistelu
  2 Nykytila ja sen arviointi
    - Aiemman lain vaikutukset
    - Ilmaantuneet puutteet tai ongelmat
  3 Tavoitteet
  ...
  11 Suhde muihin esityksiin
    11.1 Suhde aiempaan hallituksen esitykseen / lakiin
...
```
┌─────────────────────────────┬──────────────────────────────┐
│ VANHA TEKSTI                │ UUSI TEKSTI                  │
├─────────────────────────────┼──────────────────────────────┤
│ Pykälä 5                    │ Pykälä 5                     │
│ (entinen teksti)            │ (muutettu teksti)            │
│                             │                              │
│ Asiakas on oikeutettu       │ Asiakas on oikeutettu        │
│ käyttämään palvelua.        │ käyttämään palvelua 24/7.    │
│                             │ (muutos)                     │
└─────────────────────────────┴──────────────────────────────┘
```
...
Poistetut osat esitetään ___yliviivattuna___.
Uudet osat esitetään *lihavoidulla* tai <u>alleviivatulla</u>.

Esimerkki:
"Asiakas on oikeutettu käyttämään ___palvelua arkisin___ *palvelua
24/7*."
```
...
___Poistetut__ osat yliviivattuna.
...
Viitattavissa on, että pykälä on muuttunut, mutta
